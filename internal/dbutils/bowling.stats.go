...
func Read_Overall_Bowling_Aggregate_Stats(ctx context.Context, db DB_Exec, queryMap url.Values) (responses.Overall_Bowling_Aggregate_Group, error) {
	...
	err = db.QueryRow(ctx, query, args...).Scan(&response.PlayersCount, &response.MinDate, &response.MaxDate, &response.MatchesPlayed, &response.InningsBowled, &response.OversBowled, &response.MaidenOvers, &response.RunsConceded, &response.WicketsTaken, &response.Average, &response.StrikeRate, &response.Economy, &response.FourWktHauls, &response.FiveWktHauls, &response.TenWktHauls, &response.BestMatchWkts, &response.BestMatchRuns, &response.BestInningsWkts, &response.BestInningsRuns, &response.FoursConceded, &response.SixesConceded)
