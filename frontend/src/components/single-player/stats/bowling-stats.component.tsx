...
import { ICombinedBowlingStatsType, IOverall_Bowling_Summary_Group } from "@/lib/types/bowling-stats.types";
import { BowlingCommonTable } from "@/components/stats/tables/bowling-common-table.component";
