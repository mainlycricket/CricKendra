...
import { ISeriesHeader } from "@/lib/types/single-series";
import { IMatchInfo } from "@/lib/types/single-match";
    ...
    <div className="w-full md:w-3/4">
      <Tabs defaultValue={fixture_matches?.length ? "fixtures" : "results"}>
        ...
        <TabsContent value="top-performers" className="mt-2 flex flex-col gap-4 md:flex-row">
          <TopBatters topBatters={series_header.top_batters} />
          <TopBowlers topBowlers={series_header.top_bowlers} />
        </TabsContent>
      </Tabs>
    </div>
  );
